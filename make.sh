...
vasmm68k_mot -quiet -Faout -mid=2 -phxass -nowarn=62 "./src/serial.s" -o "./obj/serial.o"
vasmm68k_mot -quiet -Faout -mid=2 -phxass -nowarn=62 "./src/errors.s" -o "./obj/errors.o"

cp ./resource/*.RSH ./src/

echo "Linking..."
vlink -EB -bataritos -x -nostdlib -Cvbcc $VBCC/targets/m68k-atari/lib/startup.o "./obj/errors.o" "./obj/serial.o" "./obj/aeslib.o" "./obj/vdilib.o" "./obj/globals.o" "./obj/strings.o" "./obj/kspacket.o" "./obj/polygon.o" "./obj/surfcmap.o" "./obj/mainwnd.o" -lm -L$VBCC/targets/m68k-atari/lib -lvc -o KSP.PRG
